...
var ParsedClassicsDiagramGenerator = {
  ...
  prefillOptionsInputs: function() {
    ...
    // put default value inside field input
      ...
      ParsedClassicsDiagramGenerator.column_left_distance = val_default; // added in v.1.6.6 from v. 1.6.14 in order to be able to display diagram when no column_left_distance saved in local storage
    }
  },
