/*
From: https://www.jqueryscript.net/tooltip/Minimal-CSS3-Animated-jQuery-Popover-Plugin.html
License: MIT
*/
...
;(function ( $, window, document, undefined ) {
  ...
  Popover.prototype.toggle = function() {
    if (this.$wrapper) {
      this.$wrapper.find("div.pc-info-popover").remove(); // added by ParsedClassics
      var $popover_modal = $("#pc-info-popover").clone().removeAttr("id"); // added by ParsedClassics
      this.$el.after($popover_modal); // added by ParsedClassics
