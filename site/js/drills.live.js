/*
 * From: https://github.com/JonathanAquino/Dowlings-Wheel
 * MIT license
 */
...
dw.table['new'] = (function() {
    ...
    _.initialize = function () {
        //$('#text').before('<p class="status">LiveCorrect enabled</p>'); // Commented out by ParsedClassics
    ...
    _.validate = function () {
        ...
        var nonEmptyInputLines =inputLines.filter(line => line.trim() !== ""); // added by ParsedClassics
