    ...
    prototype: {
      ...
      itemActivate: function ($a, hideDeeperSubs) {
        ...
        if (
          ...
          $(".sm-menu-button").removeClass("highlighted"); // By ParsedClassics to guarantee that only one button will be shown as focused
          $(".sm-menu-content").hide(); // By ParsedClassics to guarantee that only one dropdown will be shown at a time
          this.menuShow($sub);
        }
      },
      itemBlur: function (e) {
      ...
      itemClick: function (e) {
        ...
        } else if (firstLevelSub) {
          // by ParsedClassics in order to be able to close menucontent by clicking menubutton
          this.itemActivate($a); // by ParsedClassics
          this.menuHide($sub); // by ParsedClassics
          return false; // by ParsedClassics
        } // by ParsedClassics
        if (
      ...
      menuHide: function ($sub) {
        ...
        if ($sub.css("display") != "none") {
          ...
          //console.info("$sub.dataSM('parent-a')", $sub.dataSM("parent-a"));
          $sub
            .dataSM("parent-a")
