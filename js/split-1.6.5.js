...
//const document = !ssr ? global.document : undefined // commented out by ParsedClassics
...
const bg_color_success = '#c4e1a4';  // by ParsedClassics
const bg_color_danger = '#e1a4a4';   // by ParsedClassics
...
const Split = (idsOption, options = {}) => {
    ...
    function setElementSize(el, size, gutSize, i, dragging) { // parameter 'dragging' added by ParsedClassics
        ...
        Object.keys(style).forEach(prop => {
            ...
            if (!dragging) {                               // by ParsedClassics
                el.style[prop] = style[prop] 
            }                                              // by ParsedClassics
            else {                                         // by ParsedClassics
              if (dimension === 'width') {                 // by ParsedClassics
                el.setAttribute('data-width', style[prop]);// by ParsedClassics
              }                                            // by ParsedClassics
              else {                                       // by ParsedClassics
                el.setAttribute('data-height', style[prop]);// by ParsedClassics
              }                                             // by ParsedClassics
            }
        })
    }
    ...
    function getIds() {         // by ParsedClassics
      return [`#${parent.id}`, ids];  // by ParsedClassics
    }                           // by ParsedClassics
    ...
    function adjust(offset, dragging) { // parameter 'dragging' added by ParsedClassics
        ...
        setElementSize(a.element, a.size, this[aGutterSize], a.i, dragging) // parameter 'dragging' added by ParsedClassics
        setElementSize(b.element, b.size, this[bGutterSize], b.i, dragging) // parameter 'dragging' added by ParsedClassics
    }
    ...
    function drag(e) {
        ...
        if (offset <= a.minSize + a.snapOffset + this[aGutterSize]) {
            ...
            this.gutter_clone.style['background'] = bg_color_danger; // by ParsedClassics
        } else if (
            offset >=
          ...
          this.gutter_clone.style['background'] = bg_color_success; // by ParsedClassics
        }
        ...
        if (dimension === 'width') {                                                 // by ParsedClassics
          ...
          this.gutter_clone.style['top'] = offset - this[aGutterSize] + 'px';        // by ParsedClassics
        }                                                                            // by ParsedClassics
        

        // Actually adjust the size.
        adjust.call(this, offset, true)
    ...
    function stopDragging() {
        ...
        if (dimension === 'width') {                             // by ParsedClassics
          const a_width = a.getAttribute("data-width");          // by ParsedClassics
          const b_width = b.getAttribute("data-width");          // by ParsedClassics
          if (a_width && b_width) {                              // by ParsedClassics
            a.style['width'] =  a_width;                         // by ParsedClassics
            b.style['width'] =  b_width                          // by ParsedClassics
          }                                                      // by ParsedClassics
          ParsedClassicsLayout.markTabsToReload([a.id, b.id]);   // by ParsedClassics
        }                                                        // by ParsedClassics
        else {                                                   // by ParsedClassics
          const a_height = a.getAttribute("data-height");        // by ParsedClassics
          const b_height = b.getAttribute("data-height");        // by ParsedClassics
          if (a_height && b_height) {                            // by ParsedClassics
            a.style['height'] = a_height;                        // by ParsedClassics 
            b.style['height'] = b_height                         // by ParsedClassics 
          }                                                      // by ParsedClassics
        }                                                        // by ParsedClassics
        self.gutter_clone.remove();                              // by ParsedClassics
    }
    ...
    function startDragging(e) {
        ...
        const gutter_clone = self.gutter.cloneNode(true);               // by ParsedClassics
        gutter_clone.style['position'] = 'absolute';                    // by ParsedClassics
        gutter_clone.style['z-index'] = 10000;                          // by ParsedClassics
        gutter_clone.style['background'] = bg_color_success;                   // by ParsedClassics
        if (dimension === 'width') {                                    // by ParsedClassics
          gutter_clone.style['left'] = self.gutter.offsetLeft + 'px';   // by ParsedClassics
        }                                                               // by ParsedClassics
        else {                                                          // by ParsedClassics
          gutter_clone.style['top'] = self.gutter.offsetTop + 'px';     // by ParsedClassics
        }                                                               // by ParsedClassics
        self.gutter_clone = gutter_clone;                               // by ParsedClassics
        self.parent.appendChild(gutter_clone);                          // by ParsedClassics
    }
    ...
    return {
        setSizes,
        getSizes,
        getIds,                         // added by ParsedClassics
        collapse(i) {
...
//export default Split;                 // commented out by ParsedClassics
