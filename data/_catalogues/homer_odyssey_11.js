...
ParsedClassicsCollDefs.homer_odyssey_11["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_odyssey_11_parsed_text: {
		...ParsedClassicsResProtos.homer_odyssey_1_12,
		library_app_panel_title: "Ὀδυσσείας Λ",
    contents_shortname: "homer_odyssey_11_parsed_text_contents",
	},
