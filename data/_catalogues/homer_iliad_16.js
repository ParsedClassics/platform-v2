...
ParsedClassicsCollDefs.homer_iliad_16["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_iliad_16_parsed_text: {
		...ParsedClassicsResProtos.homer_iliad_13_24,
		library_app_panel_title: "Ἰλιάδος Π",
    contents_shortname: "homer_iliad_16_parsed_text_contents",
	},
