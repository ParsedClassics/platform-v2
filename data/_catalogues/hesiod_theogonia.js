...
ParsedClassicsCollDefs.hesiod_theogonia["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  hesiod_theogonia_parsed_text: {
		...ParsedClassicsResProtos.hesiod_parsed_text,
		library_app_panel_title: "Θεογονία",
    contents_shortname: "hesiod_theogonia_parsed_text_contents",
	},
