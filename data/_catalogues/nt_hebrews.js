...
ParsedClassicsCollDefs.nt_hebrews["resource_defs"] = {
  ...
  nt_hebrews_parsed_text: {
    ...
    contents_shortname: "nt_hebrews_parsed_text_contents",
    extra: {
      options: [
        "text_display_modes", 
      ],
  ...
  nt_hebrews_text_ed_robinson_pierpont: {
		...ParsedClassicsResProtos.nt_text_ed_robinson_pierpont,
		contents_shortname: "nt_hebrews_ed_robinson_pierpont_contents",
	},

  nt_hebrews_text_ed_antoniadis: {
		...ParsedClassicsResProtos.nt_text_ed_antoniadis,
		contents_shortname: "nt_hebrews_ed_antoniadis_contents",
	},

  nt_hebrews_text_ed_scrivener: {
		...ParsedClassicsResProtos.nt_text_ed_scrivener,
		contents_shortname: "nt_hebrews_ed_scrivener_contents",
	},

  nt_hebrews_text_ed_westcott_hort: {
		...ParsedClassicsResProtos.nt_text_ed_westcott_hort,
		contents_shortname: "nt_hebrews_ed_westcott_hort_contents",
	},

  nt_hebrews_text_ed_nestle_nestle: {
		...ParsedClassicsResProtos.nt_text_ed_nestle_nestle,
		contents_shortname: "nt_hebrews_ed_nestle_nestle_contents",
	},
  ...
  nt_hebrews_tr_EL_vamvas: {
    ...ParsedClassicsResProtos.nt_tr_EL_vamvas,
    contents_shortname: "nt_hebrews_tr_EL_vamvas_contents",
  },

  nt_hebrews_tr_LA_s_hieronymus: {
    ...ParsedClassicsResProtos.nt_tr_LA_s_hieronymus_vol_2,
    contents_shortname: "nt_hebrews_tr_LA_s_hieronymus_contents",
  },

  nt_hebrews_tr_LA_beza: {
    ...ParsedClassicsResProtos.nt_tr_LA_beza,
    contents_shortname: "nt_hebrews_tr_LA_beza_contents",
  },

  nt_hebrews_tr_IT_diodati: {
    ...ParsedClassicsResProtos.nt_tr_IT_diodati,
    contents_shortname: "nt_hebrews_tr_IT_diodati_contents",
  },

  nt_hebrews_tr_IT_martini: {
    ...ParsedClassicsResProtos.nt_tr_IT_martini,
    contents_shortname: "nt_hebrews_tr_IT_martini_contents",
  },

  nt_hebrews_tr_FR_ostervald: {
    ...ParsedClassicsResProtos.nt_tr_FR_ostervald,
    contents_shortname: "nt_hebrews_tr_FR_ostervald_contents",
  },

  nt_hebrews_tr_FR_segond: {
    ...ParsedClassicsResProtos.nt_tr_FR_segond,
    contents_shortname: "nt_hebrews_tr_FR_segond_contents",
  },

  nt_hebrews_tr_EN_authorised_revised: {
    ...ParsedClassicsResProtos.nt_tr_EN_authorised_revised,
    contents_shortname: "nt_hebrews_tr_EN_authorised_revised_contents",
  },

  nt_hebrews_tr_EN_young: {
    ...ParsedClassicsResProtos.nt_tr_EN_young,
    contents_shortname: "nt_hebrews_tr_EN_young_contents",
  },

  nt_hebrews_tr_DE_luther: {
    ...ParsedClassicsResProtos.nt_tr_DE_luther,
    contents_shortname: "nt_hebrews_tr_DE_luther_contents",
  },

  nt_hebrews_tr_DE_menge: {
    ...ParsedClassicsResProtos.nt_tr_DE_menge,
    contents_shortname: "nt_hebrews_tr_DE_menge_contents",
  },

  // Commentaries

  nt_hebrews_commentary_by_oecumenius: {
    ...ParsedClassicsResProtos.nt_commentary_by_oecumenius_vol_2,
    contents_shortname: "nt_hebrews_commentary_by_oecumenius_contents",
  },

  nt_hebrews_commentary_by_theophylactus: {
    ...ParsedClassicsResProtos.nt_commentary_by_theophylactus,
    contents_shortname: "nt_hebrews_commentary_by_theophylactus_contents",
  },

  nt_hebrews_commentary_by_bengel: {
    ...ParsedClassicsResProtos.nt_commentary_by_bengel,
    contents_shortname: "nt_hebrews_commentary_by_bengel_contents",
  },

  nt_hebrews_commentary_by_rosenmueller: {
    ...ParsedClassicsResProtos.nt_commentary_by_rosenmueller_vol_5,
    contents_shortname: "nt_hebrews_commentary_by_rosenmueller_contents",
  },

  nt_hebrews_commentary_by_sales: {
    ...ParsedClassicsResProtos.nt_commentary_by_sales_vol_2,
    contents_shortname: "nt_hebrews_commentary_by_sales_contents",
  },
  ...
  nt_hebrews_commentary_by_nicoll: {
    ...
    contents_shortname: "nt_hebrews_commentary_by_nicoll_contents",
  },

  nt_hebrews_commentary_by_vincent: {
    ...ParsedClassicsResProtos.nt_commentary_by_vincent_vol_4,
    contents_shortname: "nt_hebrews_commentary_by_vincent_contents",
  },

  nt_hebrews_commentary_by_meyer: {
    ...ParsedClassicsResProtos.nt_commentary_by_meyer_vol_13, 
    contents_shortname: "nt_hebrews_commentary_by_meyer_contents",
  },
  ...
  nt_hebrews_audio_by_karvounakis: {
    ...
    contents_shortname: "nt_hebrews_audio_by_karvounakis_contents",
  },

  nt_hebrews_audio_by_vavylis: {
    ...ParsedClassicsResProtos.nt_audio_by_vavylis,
    contents_shortname: "nt_hebrews_audio_by_vavylis_contents",
  },
