...
ParsedClassicsCollDefs.homer_odyssey_18["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_odyssey_18_parsed_text: {
		...ParsedClassicsResProtos.homer_odyssey_13_24,
		library_app_panel_title: "Ὀδυσσείας Σ",
    contents_shortname: "homer_odyssey_18_parsed_text_contents",
	},
