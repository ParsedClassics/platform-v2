...
ParsedClassicsCollDefs.homer_iliad_15["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_iliad_15_parsed_text: {
		...ParsedClassicsResProtos.homer_iliad_13_24,
		library_app_panel_title: "Ἰλιάδος Ο",
    contents_shortname: "homer_iliad_15_parsed_text_contents",
	},
