...
ParsedClassicsCollDefs.homer_odyssey_3["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_odyssey_3_parsed_text: {
		...ParsedClassicsResProtos.homer_odyssey_1_12,
		library_app_panel_title: "Ὀδυσσείας Γ",
    contents_shortname: "homer_odyssey_3_parsed_text_contents",
	},
