...
ParsedClassicsCollDefs.hesiod_erga_kai_hmerai["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  hesiod_erga_kai_hmerai_parsed_text: {
		...ParsedClassicsResProtos.hesiod_parsed_text,
		library_app_panel_title: "Ἔργα καὶ Ἡμέραι",
    contents_shortname: "hesiod_erga_kai_hmerai_parsed_text_contents",
	},
