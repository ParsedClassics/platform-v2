...
ParsedClassicsCollDefs.homeric_hymns["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homeric_hymns_parsed_text: {
    ...ParsedClassicsResProtos.homeric_hymns_parsed_text,
    library_app_panel_title: "Ὁμηρικοὶ ὕμνοι",
    contents_shortname: "homeric_hymns_parsed_text_contents",
  },
