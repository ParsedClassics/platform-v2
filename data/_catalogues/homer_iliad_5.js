...
ParsedClassicsCollDefs.homer_iliad_5["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_iliad_5_parsed_text: {
		...ParsedClassicsResProtos.homer_iliad_1_12,
		library_app_panel_title: "Ἰλιάδος Ε",
    contents_shortname: "homer_iliad_5_parsed_text_contents",
	},
