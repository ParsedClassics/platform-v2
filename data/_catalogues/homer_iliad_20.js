...
ParsedClassicsCollDefs.homer_iliad_20["resource_defs"] = {
  // Parsed text
  // IMPORTANT!
  // The contents of the first resource of the type "Parsed text" serves as contents of the whole collection

  homer_iliad_20_parsed_text: {
		...ParsedClassicsResProtos.homer_iliad_13_24,
		library_app_panel_title: "Ἰλιάδος Υ",
    contents_shortname: "homer_iliad_20_parsed_text_contents",
	},
